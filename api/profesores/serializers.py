...
from app_natagua.models import Profesor, Provincia, Localidad


class ProfesorPagSerializer(serializers.Serializer):
    class Meta:
        model = Profesor
...
class ProfesorSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        """
        Create and return a new `Profesor` instance, given the validated data.
        """
        ...
        trans = Profesor.objects.create(**validated_data)

        return trans

    def update(self, instance, validated_data):
        """
            Update and return an existing `Profesor` instance, given the validated data.
        """

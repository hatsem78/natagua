# Generated by Django 2.1.2 on 2018-11-13 09:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app_natagua', '0025_auto_20181112_1839'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_localidad', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='localidad_alumno', to='app_natagua.Localidad')),
                ('id_provincia', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='provincia_alumno', to='app_natagua.Provincia')),
            ],
            options={
